...
# Constantes 
data_path = '/c/Users/tiago/airflow/data/microdados_enade_2019/2019/3.DADOS/'
arquivo = data_path + 'microdados_enade_2019.txt'

# Argumentos default 
default_args = {
    'owner': 'Tiago Navarro',                                   # é o 'dono/proprietario' da DAG, informar um nome fácil para identificação
    ...
    'email': ['tiagornavarro@gmail.com.br'],                    # Email que irá receber informações sobre a DAG
...
get_data = BashOperator(
    task_id='get-data',
    bash_command='curl http://download.inep.gov.br/microdados/Enade_Microdados/microdados_enade_2019.zip -o /c/Users/tiago/airflow/data/microdados_enade_2019.zip', 
    dag=dag
)

# função para extrair o arquivo
def unzip_file():
    with zipfile.ZipFile('/c/Users/tiago/airflow/data/microdados_enade_2019.zip', 'r') as zipped:
        zipped.extractall('/c/Users/tiago/airflow/data')
